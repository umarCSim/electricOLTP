CREATE VIEW [dbo].[CRA_R014B001_Incoming_View]
AS
SELECT
	--AAA
	[FileHeaderId]
	...
	,[RegistrationType]
	--IGG
      ,[InterGSPGroupConnectionDetails]
      ,[ActionCode]
      ,[RegistrationStatus]
      ,[InterGSPGroupConnectionId]
      ,[EffectiveFromDate]
      ,[EffectiveToDate]
FROM AAA
...
INNER JOIN [dbo].[IGG_V1] ON [IGG_V1].FK_FileHeaderId = AAA.FileHeaderId
