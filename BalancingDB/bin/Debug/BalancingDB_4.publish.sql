...
GO
PRINT N'Altering [dbo].[SP_Incoming_History]...';


GO
ALTER PROCEDURE [dbo].[SP_Incoming_History] @FileHeaderId INT
	,@FlowKeyId INT
...
GO
/*
This SP will perform validations 2 and 3 on all incoming flows.
Validation 1 is handled by the initial insert of the header
*/

CREATE PROCEDURE [dbo].[SP_ValidateHeader] @FK_FileHeaderId INT
	,@FK_HistoryId INT
	,@ReceivedTime DATETIME2
	,@FileName VARCHAR(14)
	--,@ResponseData VARCHAR(80)
	,@ToParticipantIdCol VARCHAR(8)
	,@ToparticipantIdParam VARCHAR(8)
	,@Sequence BIGINT
AS
IF (@ToParticipantIdCol <> @ToparticipantIdParam)
	INSERT INTO ADT (
		[FK_FileHeaderId]
		,[FK_HistoryId]
