...
IF EXISTS (select top 1 1 from [dbo].[Incoming_History])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping unnamed constraint on [dbo].[Incoming_History]...';


GO
ALTER TABLE [dbo].[Incoming_History] DROP CONSTRAINT [FK__Incoming___ADTId__2DA7A64D];
...
GO
ALTER TABLE [dbo].[Incoming_History] DROP COLUMN [ADTId];
