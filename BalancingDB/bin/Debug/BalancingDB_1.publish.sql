...
GO
PRINT N'Creating [dbo].[SP_ValidateHeader_ParticipantDetails]...';


GO
CREATE PROCEDURE [dbo].[SP_ValidateHeader_ParticipantDetails] @FK_FileHeaderId INT
	,@FK_HistoryId INT
	...
	,@ToRoleParam VARCHAR(2)
	,@ToparticipantIdParam VARCHAR(8)
	,@Sequence BIGINT
AS
IF (
		@ToRoleCol <> @ToRoleParam
		OR @ToParticipantIdCol <> @ToparticipantIdParam
		)
	INSERT INTO ADT (
		[FK_FileHeaderId]
		,[FK_HistoryId]
